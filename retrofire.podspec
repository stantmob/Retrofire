#
#  Be sure to run `pod spec lint retrofire.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Rachid Calazans"
   ...
   s.social_media_url   = "https://twitter.com/rcachidcalazans"
  ...
  s.source       = { :git => "https://github.com/stantmob/Retrofire.git", :tag => "#{s.version}" }
